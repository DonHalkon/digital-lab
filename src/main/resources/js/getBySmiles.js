function findBySmiles() {
    ...
    try {
        ...
        if ('' !== smiles) {
            ...
            xmlHttp.open("GET", "https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/smiles/" + encodeURI(smiles) + "/property/IUPACName,MolecularFormula,MolecularWeight/JSON", false); // false for synchronous request
            xmlHttp.send(null);
        }
    } finally {
